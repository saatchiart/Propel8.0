...
";
    ...
    {
        if ($this->behavior->isArchiveOnDelete()) {
            return $this->behavior->renderTemplate('objectPreDelete', ['queryClassname' => $builder->getStubQueryBuilder()->getClassname(), 'isAddHooks'     => $builder->getGeneratorConfig()->getBuildProperty('addHooks')]);
        }
    }
    ...
    {
        return $this->behavior->renderTemplate('objectGetArchive', ['archiveTablePhpName'   => $this->behavior->getArchiveTablePhpName($builder), 'archiveTableQueryName' => $this->behavior->getArchiveTableQueryName($builder)]);
    }
    ...
    {
        return $this->behavior->renderTemplate('objectArchive', ['archiveTablePhpName'   => $this->behavior->getArchiveTablePhpName($builder), 'archiveTableQueryName' => $this->behavior->getArchiveTableQueryName($builder), 'archivedAtColumn'      => $this->behavior->getArchivedAtColumn(), 'hasArchiveClass'       => $this->behavior->hasArchiveClass()]);
    }
    ...
    {
        return $this->behavior->renderTemplate('objectRestoreFromArchive', ['objectClassname' => $this->builder->getObjectClassname()]);
    }
    ...
    {
        return $this->behavior->renderTemplate('objectPopulateFromArchive', ['archiveTablePhpName' => $this->behavior->getArchiveTablePhpName($builder), 'usesAutoIncrement'   => $this->table->hasAutoIncrementPrimaryKey(), 'fakeAutoIncrementParameter' => $this->fakeAutoIncrementPrimaryKeyForConcreteInheritance(), 'objectClassname'     => $this->builder->getObjectClassname(), 'columns'             => $this->table->getColumns()]);
    }
    ...
    {
        return $this->behavior->renderTemplate('objectSaveWithoutArchive', ['objectClassname'   => $this->builder->getObjectClassname(), 'isArchiveOnInsert' => $this->behavior->isArchiveOnInsert(), 'isArchiveOnUpdate' => $this->behavior->isArchiveOnUpdate()]);
    }
    ...
    {
        return $this->behavior->renderTemplate('objectDeleteWithoutArchive', ['objectClassname' => $this->builder->getObjectClassname()]);
    }
}
