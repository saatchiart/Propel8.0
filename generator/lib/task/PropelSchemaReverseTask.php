...
class PropelSchemaReverseTask extends PDOTask
{
     ...
     */
    final public const VALIDATORS_NONE = 0;

    /**
     * Bit for maxLength validator
     */
    final public const VALIDATORS_MAXLENGTH = 1;

    /**
     * Bit for maxValue validator
     */
    final public const VALIDATORS_MAXVALUE = 2;

    /**
     * Bit for type validator
     */
    final public const VALIDATORS_TYPE = 4;

    /**
     * Bit for required validator
     */
    final public const VALIDATORS_REQUIRED = 8;

    /**
     * Bit for unique validator
     */
    final public const VALIDATORS_UNIQUE = 16;

    /**
     * Bit for all validators
     */
    final public const VALIDATORS_ALL = 255;
     ...
     * @var        array
     */
    protected static $validatorBitMap = ['none' => PropelSchemaReverseTask::VALIDATORS_NONE, 'maxlength' => PropelSchemaReverseTask::VALIDATORS_MAXLENGTH, 'maxvalue' => PropelSchemaReverseTask::VALIDATORS_MAXVALUE, 'type' => PropelSchemaReverseTask::VALIDATORS_TYPE, 'required' => PropelSchemaReverseTask::VALIDATORS_REQUIRED, 'unique' => PropelSchemaReverseTask::VALIDATORS_UNIQUE, 'all' => PropelSchemaReverseTask::VALIDATORS_ALL];
    ...
    public function main()
    {
        ...
        $this->doc->appendChild($this->doc->createComment("Autogenerated by " . static::class . " class."));
    ...
    protected function addValidators(Database $database)
    {
        ...
        foreach ($database->getTables() as $table) {
            ...
            foreach ($table->getUnices() as $unique) {
                ...
                if ((is_countable($colnames) ? count($colnames) : 0) == 1) { // currently 'unique' validator only works w/ single columns.
