...
class QueryBuilderTest extends BookstoreTestBase
{
    ...
    public function testFilterByPrimaryKeysSimpleKey()
    {
        ...
        $q1 = BookQuery::create()->add(BookPeer::ID, [10, 11, 12], Criteria::IN);
    ...
    public function testFilterByIntegerPk()
    {
        ...
        $q1 = BookQuery::create()->add(BookPeer::ID, [10, 11, 12], Criteria::NOT_IN);
    ...
    public function testFilterByNumber()
    {
        ...
        $q1 = BookQuery::create()->add(BookPeer::PRICE, [10, 11, 12], Criteria::IN);
        ...
        $q1 = BookQuery::create()->add(BookPeer::PRICE, [10, 11, 12], Criteria::NOT_IN);
    ...
    public function testFilterByString()
    {
        ...
        $q1 = BookQuery::create()->add(BookPeer::TITLE, ['foo', 'bar'], Criteria::IN);
        ...
        $q1 = BookQuery::create()->add(BookPeer::TITLE, ['foo', 'bar'], Criteria::NOT_IN);
