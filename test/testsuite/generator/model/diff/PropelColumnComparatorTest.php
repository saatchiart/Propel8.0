...
class PropelColumnComparatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCompareNoDifference()
    {
        ...
        $this->assertEquals([], PropelColumnComparator::compareColumns($c1, $c2));
    }
    ...
    public function testCompareType()
    {
        ...
        $expectedChangedProperties = ['type'    => ['VARCHAR', 'LONGVARCHAR'], 'sqlType' => ['VARCHAR', 'TEXT']];
    ...
    public function testCompareDefaultValueToNull()
    {
        ...
        $c1->getDomain()->setDefaultValue(new ColumnDefaultValue(123, ColumnDefaultValue::TYPE_VALUE));
        $c2 = new Column();
        $expectedChangedProperties = ['defaultValueType' => [ColumnDefaultValue::TYPE_VALUE, null], 'defaultValueValue' => [123, null]];
        $this->assertEquals($expectedChangedProperties, PropelColumnComparator::compareColumns($c1, $c2));
    }
    ...
    public function testCompareDefaultValueFromNull()
    {
        ...
        $c2 = new Column();
        $c2->getDomain()->setDefaultValue(new ColumnDefaultValue(123, ColumnDefaultValue::TYPE_VALUE));
        $expectedChangedProperties = ['defaultValueType' => [null, ColumnDefaultValue::TYPE_VALUE], 'defaultValueValue' => [null, 123]];
        $this->assertEquals($expectedChangedProperties, PropelColumnComparator::compareColumns($c1, $c2));
    }
    ...
    public function testCompareDefaultValueValue()
    {
        ...
        $expectedChangedProperties = ['defaultValueValue' => [123, 456]];
        $this->assertEquals($expectedChangedProperties, PropelColumnComparator::compareColumns($c1, $c2));
    }
    ...
    public function testCompareDefaultValueType()
    {
        ...
        $expectedChangedProperties = ['defaultValueType' => [ColumnDefaultValue::TYPE_VALUE, ColumnDefaultValue::TYPE_EXPR]];
        $this->assertEquals($expectedChangedProperties, PropelColumnComparator::compareColumns($c1, $c2));
    }
    ...
    public function testCompareMultipleDifferences()
    {
        ...
        $c2->setNotNull(true);
        $c2->getDomain()->setDefaultValue(new ColumnDefaultValue(123, ColumnDefaultValue::TYPE_VALUE));
        $expectedChangedProperties = ['type' => ['INTEGER', 'DOUBLE'], 'sqlType' => ['INTEGER', 'DOUBLE'], 'scale' => [NULL, 2], 'size' => [NULL, 3], 'notNull' => [false, true], 'defaultValueType' => [NULL, ColumnDefaultValue::TYPE_VALUE], 'defaultValueValue' => [NULL, 123]];
        $this->assertEquals($expectedChangedProperties, PropelColumnComparator::compareColumns($c1, $c2));
    }
}
