...
class PropelTablePkColumnComparatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCompareAddedPkColumn()
    {
        ...
        $this->assertEquals(1, is_countable($tableDiff->getAddedPkColumns()) ? count($tableDiff->getAddedPkColumns()) : 0);
    ...
    public function testCompareRemovedPkColumn()
    {
        ...
        $tableDiff = $tc->getTableDiff();
        $this->assertEquals(1, $nbDiffs);
        $this->assertEquals(1, is_countable($tableDiff->getRemovedPkColumns()) ? count($tableDiff->getRemovedPkColumns()) : 0);
    ...
    public function testCompareRenamedPkColumn()
    {
        ...
        $tableDiff = $tc->getTableDiff();
        $this->assertEquals(1, $nbDiffs);
        $this->assertEquals(1, is_countable($tableDiff->getRenamedPkColumns()) ? count($tableDiff->getRenamedPkColumns()) : 0);
