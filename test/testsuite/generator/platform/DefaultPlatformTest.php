...
class DefaultPlatformTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return [[$this->createColumn(PropelTypes::INTEGER, 0), "DEFAULT 0"], [$this->createColumn(PropelTypes::INTEGER, '0'), "DEFAULT 0"], [$this->createColumn(PropelTypes::VARCHAR, 'foo'), "DEFAULT 'foo'"], [$this->createColumn(PropelTypes::VARCHAR, 0), "DEFAULT '0'"], [$this->createColumn(PropelTypes::BOOLEAN, true), "DEFAULT 1"], [$this->createColumn(PropelTypes::BOOLEAN, false), "DEFAULT 0"], [$this->createColumn(PropelTypes::BOOLEAN, 'true'), "DEFAULT 1"], [$this->createColumn(PropelTypes::BOOLEAN, 'false'), "DEFAULT 0"], [$this->createColumn(PropelTypes::BOOLEAN, 'TRUE'), "DEFAULT 1"], [$this->createColumn(PropelTypes::BOOLEAN, 'FALSE'), "DEFAULT 0"], [$this->createEnumColumn(['foo', 'bar', 'baz'], 'foo'), "DEFAULT 0"], [$this->createEnumColumn(['foo', 'bar', 'baz'], 'bar'), "DEFAULT 1"], [$this->createEnumColumn(['foo', 'bar', 'baz'], 'baz'), "DEFAULT 2"]];
    }
